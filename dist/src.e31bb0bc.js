...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"animations.js":[function(require,module,exports) {
"use strict";
...
var Animations = /*#__PURE__*/function () {
  function Animations(el) {
    ...
    this.DOM.circleText = _toConsumableArray(this.DOM.el.querySelectorAll(".text"));
    this.DOM.words = _toConsumableArray(this.DOM.el.querySelectorAll(".word")).reverse();
    this.timelines = [];
  ...
  _createClass(Animations, [{
    ...
    value: function initialize() {
      ...
      _gsap.gsap.set(this.DOM.circleText[0], {
        rotate: 105
      });
    ...
    value: function start() {
      ...
      this.DOM.circleText.forEach(function (x, i) {
        _this2.timelines.push(_gsap.gsap.timeline().to(x, {
          duration: 30 - 2 * i * 3,
          ease: "linear",
          rotate: (i % 2 ? "-" : "+") + "=360",
          repeat: -1
      ...
      _gsap.gsap.to([DOM.enterCtrl, this.DOM.circleText], {
        duration: 2,
        ease: "expo",
        startAt: {
          opacity: 0,
        ...
        onComplete: function onComplete() {
          return _this2.addEvents();
        }
      });

      this.DOM.words.forEach(function (x, i) {
        _gsap.gsap.timeline({
          repeat: -1,
          ...
          duration: _this2.wordsAnimation,
          fill: _this2.originalColors[i < 3 ? 0 : 1]
        }).restart(true);
      });
    }
  }, {
    ...
    value: function enter() {
      ...
      this.removeEvents();
      this.timelines.forEach(function (x) {
        return x.kill();
      });
      ...
      _gsap.gsap.timeline().addLabel("enter", 0).to(DOM.enterCtrl, {
        duration: 1.5,
        ease: "expo.inOut",
        scale: 0.4,
        opacity: 0
      }, 0).to(this.DOM.circleText, {
        duration: 1.5,
        ease: "expo.inOut",
        scale: function scale(i) {
          return 1.5 + (_this3.circleTextTotal - i) * 0.4;
        },
        opacity: 0,
        stagger: {
          amount: 0.3
...
var animations = new _animations.Animations(document.querySelector(".circles"));
animations.start();

...
const animations = new _animations.Animations(document.querySelector(".circles"));
animations.start();

},{"./animations":"6DCE6"}],"6DCE6":[function(require,module,exports) {
...
class Animations {
    constructor(el){
        ...
        this.DOM.circleText = [
            ...this.DOM.el.querySelectorAll(".text")
        ];
        this.DOM.words = [
            ...this.DOM.el.querySelectorAll(".word")
        ].reverse();
        this.timelines = [];
        this.colors = [
            "#ffffff",
    ...
    start() {
        this.DOM.circleText.forEach((x, i)=>{
            this.timelines.push(_gsap.gsap.timeline().to(x, {
                duration: 30 - 2 * i * 3,
                ease: "linear",
                rotate: (i % 2 ? "-" : "+") + "=360",
                repeat: -1
...
},{"./gsap-core.js":"3CNdC","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["8Ye98","6cF5V"], "6cF5V", "parcelRequiree899")
